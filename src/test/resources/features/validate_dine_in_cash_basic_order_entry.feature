...
Feature: Dine in cash basic order entry
  ...
  Scenario: validate_dine_in_cash_basic_order_entry_Testcase
    ...
    And the user validates the background color of the "dinInColor" element is "rgba(0, 0, 0, 0)" at the "OrderEntry" page "validate_background_color" "HardStopOnFailure"
