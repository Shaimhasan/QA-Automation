Feature: Basic Order Tracker - Take Out Cash - with all lines enabled - Change Size - Existing User
  This script is to validate Basic Order Tracker - Take Out Cash - with all lines enabled - Change Size - Existing User

  @issue=1782
  @BOT_By_Order_Submitted_Btn_Take_Out_Cash_With_ALE_Change_Size_Existing_User @RegressionSuite @Submitted @Guest
  Scenario: BOT_By_Order_Submitted_Btn_Take_Out_Cash_With_ALE_Change_Size_Existing_User_Testcase
