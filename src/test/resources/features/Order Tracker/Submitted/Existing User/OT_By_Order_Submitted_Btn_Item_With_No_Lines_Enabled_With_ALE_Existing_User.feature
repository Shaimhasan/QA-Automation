Feature: Online Tracker - Item with no lines enabled - with all lines enabled - Existing User
  This script is to validate Online Tracker - Item with no lines enabled - with all lines enabled - Existing User

  @issue=3049
  @OT_By_Order_Submitted_Btn_Item_With_No_Lines_Enabled_With_ALE_Existing_User @RegressionSuite @Others @OLO @OLO_ALE @OO_ALE_Guest
  Scenario: OT_By_Order_Submitted_Btn_Item_With_No_Lines_Enabled_With_ALE_Existing_User_Testcase
