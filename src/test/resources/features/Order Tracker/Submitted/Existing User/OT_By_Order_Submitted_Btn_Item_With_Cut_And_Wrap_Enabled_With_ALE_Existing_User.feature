Feature: Order Tracker - Item with Cut and Wrap enabled - with all lines enabled - Existing User
  This script is to validate Order Tracker - Item with Cut and Wrap enabled - with all lines enabled - Existing User

  @issue=3051
  @OT_By_Order_Submitted_Btn_Item_With_Cut_And_Wrap_Enabled_With_ALE_Existing_User @RegressionSuite @Others @OLO @OLO_ALE @OO_ALE_Guest @Smoke_Testing
  Scenario: OT_By_Order_Submitted_Btn_Item_With_Cut_And_Wrap_Enabled_With_ALE_Existing_User_Testcase
