Feature: Basic Order Tracker By Order Summitted Button - Dine In Cash - with all lines enabled - Guest
  This script is to validate Basic Order Tracker By Order Summitted Button - Dine In Cash - with all lines enabled - Guest

  @issue=1780
  @BOT_By_Order_Submitted_Btn_Dine_In_Cash_With_ALE_Guest @RegressionSuite @Submitted @Guest @Existing_User
