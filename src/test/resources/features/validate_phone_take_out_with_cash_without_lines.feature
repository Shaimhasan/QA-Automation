@phoneTakeOutWithCashWithoutLines
Feature: Phone take out with cash without lines
  This script is to validate  phone take out with cash without lines

  @validate_phone_take_out_with_cash_without_lines @RegressionSuite
  Scenario: validate_phone_take_out_with_cash_without_lines_Testcase
    ...
    #Comment: user click on phoneTakeOut
    And the user clicks the "`phoneTakeOut`" element at the "OrderEntry" page
