Feature: Online Order - Item with Cut and Wrap enabled - with all lines enabled - Guest
  This script is to validate Online Order - Item with Cut and Wrap enabled - with all lines enabled - Guest

  @issue=3051
  @Online_Order_Item_With_Cut_And_Wrap_Enabled_With_All_Lines_Enabled_Guest @RegressionSuite @OLO @OLO_ALE @OLO_ALE_DineIn @OLO_ALE_DineIn_Guest
