Feature: Online Order - Item with Prep Station enabled - with all lines enabled - Guest
  This script is to validate Online Order - Item with Prep Station enabled - with all lines enabled - Guest

  @issue=3050
  @Online_Order_Item_With_Prep_Station_Enabled_With_All_Lines_Enabled_Guest @RegressionSuite @OLO @OLO_ALE @OLO_ALE_DineIn @OLO_ALE_DineIn_Guest
  Scenario: Online_Order_Item_With_Prep_Station_Enabled_With_All_Lines_Enabled_Guest_Testcase
