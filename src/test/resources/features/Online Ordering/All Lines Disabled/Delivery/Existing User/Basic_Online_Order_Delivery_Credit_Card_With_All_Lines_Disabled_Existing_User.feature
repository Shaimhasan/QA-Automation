Feature: Basic Online Order - Delivery Credit Card - with all lines disabled - Existing User
  ...
  @issue=1818
  @Basic_Online_Order_Delivery_Credit_Card_With_All_Lines_Disabled_Existing_User @RegressionSuite @OLO @OLO_ALD @OLO_ALD_Delivery @OLO_ALD_Delivery_Existing_User
