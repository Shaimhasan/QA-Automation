Feature: Basic Order Entry - Customize an order before finishing order - with Make Line Only
  ...
  @issue=1623
  @Basic_Order_Entry_Dine_In_Cash_Customize_An_Order_Before_Finishing_Order_With_Make_Line_Only @RegressionSuite @DineIn @BOE @BOE_Make_Line_Only @BOE_Make_Line_Only_DineIn
