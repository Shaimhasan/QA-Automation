Feature: Basic Order Entry - Dine-in with half cash and half Credit Card  - with Make Line Only
  ...
  @issue=1624
  @Basic_Order_Entry_Dine_In_With_Half_Cash_And_Half_Credit_Card_With_Make_Line_Only @RegressionSuite @DineIn @BOE @BOE_Make_Line_Only @BOE_Make_Line_Only_DineIn
