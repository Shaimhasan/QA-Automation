Feature: Basic Order Entry - Dine In Cash - with Change Due  - with Make Line Only
  ...
  @issue=1620
  @Basic_Order_Entry_Dine_In_Cash_With_Changed_Due_With_Make_Line_Only @RegressionSuite @DineIn @BOE_DineIn @BOE @BOE_Make_Line_Only @BOE_Make_Line_Only_DineIn
