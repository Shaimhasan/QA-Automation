Feature: Basic Order Entry - Take Out Cash - with Change Due  - with Make Line Only
  This script is to validate Basic Order Entry - Take Out Cash - with Change Due  - with Make Line Only with 100 dollar

  @issue=1621
  @Basic_Order_Entry_Take_Out_Cash_With_Changed_Due_With_Make_Line_Only @RegressionSuite @TakeOut @BOE_TakeOut @BOE @BOE_Make_Line_Only @BOE_Make_Line_Only_TakeOut
  Scenario: Basic_Order_Entry_Take_Out_Cash_With_Changed_Due_With_Make_Line_Only_Testcase
