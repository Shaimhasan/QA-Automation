Feature: Basic Order Entry - Delivery Cash - With Change Due  - with Make Line Only
  This script is to validate Basic Order Entry - Delivery Cash - With Change Due  - with Make Line Only with 100 dollar

  @issue=1622
  @Basic_Order_Entry_Dine_In_Delivery_Cash_With_Change_Due_With_Make_Line_Only @RegressionSuite @Delivery @BOE_Delivery @BOE @BOE_Make_Line_Only @BOE_Make_Line_Only_Delivery
  Scenario: Basic_Order_Entry_Dine_In_Delivery_Cash_With_Change_Due_With_Make_Line_Only_Testcase
