Feature: Basic Order Entry - Delivery Credit Card  - with Make Line Only
  ...
  @issue=1619
  @Basic_Order_Entry_Dine_In_Delivery_Credit_Card_With_Make_Line_Only @RegressionSuite @Delivery @BOE_Delivery @BOE @BOE_Make_Line_Only @BOE_Make_Line_Only_Delivery
