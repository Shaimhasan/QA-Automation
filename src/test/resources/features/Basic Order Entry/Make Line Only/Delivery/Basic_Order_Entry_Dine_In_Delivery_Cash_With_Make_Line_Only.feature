Feature: Basic Order Entry - Delivery Cash  - with Make Line Only
  ...
  @issue=1618
  @Basic_Order_Entry_Dine_In_Delivery_Cash_With_Make_Line_Only @RegressionSuite @Delivery @BOE_Delivery @BOE @BOE_Make_Line_Only @BOE_Make_Line_Only_Delivery @Smoke_Testing
