Feature: Basic Order Entry - Delivery Credit Card  - with all lines enabled
  ...
  @Basic_Order_Entry_Dine_In_Delivery_Credit_Card_With_All_Lines_Enabled @RegressionSuite @Delivery @BOE_Delivery @BOE @BOE_ALE @BOE_ALE_Delivery @Smoke_Testing
