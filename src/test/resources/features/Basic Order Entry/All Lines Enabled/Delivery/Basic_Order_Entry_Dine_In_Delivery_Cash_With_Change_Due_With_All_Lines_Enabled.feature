Feature: Basic Order Entry - Delivery Cash - With Change Due  - with all lines enabled
  This script is to validate Basic Order Entry - Delivery Cash - With Change Due  - with all lines enabled with
  Customer pays 100 dollar

  @Basic_Order_Entry_Dine_In_Delivery_Cash_With_Change_Due_With_All_Lines_Enabled @RegressionSuite @Delivery @BOE_Delivery @BOE @BOE_ALE @BOE_ALE_Delivery
  Scenario: Basic_Order_Entry_Dine_In_Delivery_Cash_With_Change_Due_With_All_Lines_Enabled_Testcase
