Feature: Basic Order Entry - Delivery Cash  - with all lines enabled
  This script is to validate Basic Order Entry - Delivery Cash  - with all lines enabled

  @Basic_Order_Entry_Dine_In_Delivery_Cash_With_All_Lines_Enabled @RegressionSuite @Delivery @BOE_Delivery @BOE @BOE_ALE @BOE_ALE_Delivery
