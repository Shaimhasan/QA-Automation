Feature: Basic Order Entry - Customize an order before finishing order - with all lines enabled
  This script is to validate Basic Order Entry - Customize an order before finishing order - with all lines enabled

  @Basic_Order_Entry_Dine_In_Cash_Customize_An_Order_Before_Finishing_Order_With_All_Lines_Enabled @RegressionSuite @DineIn @BOE_DineIn @BOE @BOE_ALE @BOE_ALE_DineIn
  Scenario: Basic_Order_Entry_Dine_In_Cash_Customize_An_Order_Before_Finishing_Order_With_All_Lines_Enabled_Testcase
