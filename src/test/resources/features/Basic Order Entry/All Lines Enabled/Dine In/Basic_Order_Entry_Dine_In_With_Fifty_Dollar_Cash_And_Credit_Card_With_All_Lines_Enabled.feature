Feature: Basic Order Entry - Dine-in with cash and Credit Card  - with all lines enabled
  This script is to validate Basic Order Entry - Dine-in with cash and Credit Card  - with all lines enabled

  @issue=522
  @Basic_Order_Entry_Dine_In_With_Fifty_Dollar_Cash_And_Credit_Card_With_All_Lines_Enabled @RegressionSuite @DineIn @BOE_DineIn @BOE @BOE_ALE @BOE_ALE_DineIn
