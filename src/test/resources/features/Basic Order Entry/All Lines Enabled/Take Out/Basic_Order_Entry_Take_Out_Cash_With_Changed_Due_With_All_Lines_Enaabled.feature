Feature: Basic Order Entry - Take Out Cash - with Change Due  - with all lines enabled
  This script is to validate Basic Order Entry - Take Out Cash - with Change Due  - with all lines enabled with customer
  pay 100 dollar

  @Basic_Order_Entry_Take_Out_Cash_With_Changed_Due_With_All_Lines_Enabled @RegressionSuite @TakeOut @BOE_TakeOut @BOE @BOE_ALE @BOE_ALE_TakeOut
  Scenario: Basic_Order_Entry_Take_Out_Cash_With_Changed_Due_With_All_Lines_Enabled_Testcase
