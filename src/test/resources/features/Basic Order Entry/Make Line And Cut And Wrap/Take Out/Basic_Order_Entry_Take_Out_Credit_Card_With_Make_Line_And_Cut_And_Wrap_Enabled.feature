Feature: Basic Order Entry - Take Out Credit Card  - with Make Line and Cut and Wrap enabled
  ...
  @Basic_Order_Entry_Take_Out_Credit_Card_With_Make_Line_And_Cut_And_Wrap_Enabled @RegressionSuite @TakeOut @BOE @BOE_Make_Line_And_Cut_And_Wrap @BOE_Make_Line_And_Cut_And_Wrap_TakeOut
