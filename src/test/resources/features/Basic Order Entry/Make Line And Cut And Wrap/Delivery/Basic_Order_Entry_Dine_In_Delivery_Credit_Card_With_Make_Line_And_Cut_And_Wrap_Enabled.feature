Feature: Basic Order Entry - Delivery Credit Card  - with Make Line and Cut and Wrap enabled
  ...
  @issue=1654
  @Basic_Order_Entry_Dine_In_Delivery_Credit_Card_With_Make_Line_And_Cut_And_Wrap_Enabled @RegressionSuite @Delivery @BOE_Delivery @BOE @BOE_Make_Line_And_Cut_And_Wrap @BOE_Make_Line_And_Cut_And_Wrap_Delivery
