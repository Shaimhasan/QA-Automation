Feature: Basic Order Entry - Customize an order before finishing order - with Make Line and Cut and Wrap enabled
  ...
  @Basic_Order_Entry_Dine_In_Cash_Customize_An_Order_Before_Finishing_Order_With_MakeLine_And_Cut_And_Wrap @RegressionSuite @BOE @BOE_Make_Line_And_Cut_And_Wrap @BOE_Make_Line_And_Cut_And_Wrap_DineIn
  Scenario: Basic_Order_Entry_Dine_In_Cash_Customize_An_Order_Before_Finishing_Order_With_MakeLine_And_Cut_And_Wrap_Testcase
