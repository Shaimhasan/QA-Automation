Feature: Basic Order Entry - Dine In Cash - with Change Due  - with Make Line and Cut and Wrap enabled
  ...
  @issue=1653
  @Basic_Order_Entry_Dine_In_Cash_With_Changed_Due_With_Make_Line_And_Cut_And_Wrap_Enabled @RegressionSuite @BOE @BOE_Make_Line_And_Cut_And_Wrap @BOE_Make_Line_And_Cut_And_Wrap_DineIn
