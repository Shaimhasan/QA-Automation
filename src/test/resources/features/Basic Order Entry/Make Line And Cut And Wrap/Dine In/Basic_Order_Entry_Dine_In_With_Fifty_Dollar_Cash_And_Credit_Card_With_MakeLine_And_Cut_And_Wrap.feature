Feature: Basic Order Entry - Dine-in fifty dollar cash and Credit Card  - with all lines disabled
  ...
  @Basic_Order_Entry_Dine_In_With_Fifty_Dollar_Cash_And_Credit_Card_With_MakeLine_And_Cut_And_Wrap @RegressionSuite @DineIn @BOE @BOE_Make_Line_And_Cut_And_Wrap @BOE_Make_Line_And_Cut_And_Wrap_DineIn
