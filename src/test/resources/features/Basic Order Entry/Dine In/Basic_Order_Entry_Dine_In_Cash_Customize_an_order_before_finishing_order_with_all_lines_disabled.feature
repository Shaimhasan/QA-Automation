...
Feature: Basic Order Entry - Dine In Cash - Customize an order before finishing order - with all lines disabled
  This script is to validate Dine in cash basic customize order without lines

  @Basic_Order_Entry_Customize_an_order_before_finishing_order_with_all_lines_disabled @RegressionSuite
