Feature: Basic Order Entry - Delivery Credit Card  - with Prep Station and Make Line enabled
  ...
  @Basic_Order_Entry_Dine_In_Delivery_Credit_Card_With_Prep_Station_And_Make_Line_Enabled @RegressionSuite @Delivery @BOE @BOE_Prep_Station_And_Make_Line @BOE_Prep_Station_And_Make_Line_Delivery
