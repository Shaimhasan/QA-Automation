Feature: Basic Order Entry - Delivery Cash  - with Prep Station and Make Line enabled
  ...
  @Basic_Order_Entry_Dine_In_Delivery_Cash_With_Prep_Station_And_Make_Line_Enabled @RegressionSuite @Delivery @BOE @BOE_Prep_Station_And_Make_Line @BOE_Prep_Station_And_Make_Line_Delivery
