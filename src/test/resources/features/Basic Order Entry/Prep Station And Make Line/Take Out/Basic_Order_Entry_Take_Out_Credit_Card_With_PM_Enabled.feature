Feature: Basic Order Entry - Take Out Credit Card  - with Prep Station and Make Line enabled
  ...
  @Basic_Order_Entry_Take_Out_Credit_Card_With_PM_Enabled @RegressionSuite @TakeOut @BOE_TakeOut @BOE @BOE_Prep_Station_And_Make_Line @BOE_Prep_Station_And_Make_Line_TakeOut @Smoke_Testing
  Scenario: Basic_Order_Entry_Take_Out_Credit_Card_With_PM_Enabled_Testcase
