Feature: Basic Order Entry - Dine-in with half cash and half Credit Card  - with Prep Station and Make Line enabled
  ...
  @Basic_Order_Entry_Dine_In_With_Half_Cash_And_Half_Credit_Card_With_Prep_Station_Make_Line_Enabled @RegressionSuite @DineIn @BOE @BOE_Prep_Station_And_Make_Line @BOE_Prep_Station_And_Make_Line_DineIn
