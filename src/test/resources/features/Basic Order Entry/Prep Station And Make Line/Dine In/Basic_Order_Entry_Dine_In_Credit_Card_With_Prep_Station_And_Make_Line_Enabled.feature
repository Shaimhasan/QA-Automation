Feature: Basic Order Entry - Dine In Credit Card - with Prep Station and Make Line enabled
  This script is to validate Basic Order Entry - Dine In Credit Card - with Prep Station and Make Line enabled

  @issue=1647
  @Basic_Order_Entry_Dine_In_Credit_Card_With_Prep_Station_And_Make_Line_Enabled @RegressionSuite @DineIn @BOE_DineIn @BOE @BOE_Prep_Station_And_Make_Line @BOE_Prep_Station_And_Make_Line_DineIn
