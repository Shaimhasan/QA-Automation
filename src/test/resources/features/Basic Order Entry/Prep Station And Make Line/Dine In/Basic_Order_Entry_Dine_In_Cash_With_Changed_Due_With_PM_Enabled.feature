Feature: Basic Order Entry - Dine In Cash - with Change Due  - with Prep Station and Make Line enabled
  ...
  @Basic_Order_Entry_Dine_In_Cash_With_Changed_Due_With_PM_Enabled @RegressionSuite @DineIn @BOE_DineIn @BOE @BOE_Prep_Station_And_Make_Line @BOE_Prep_Station_And_Make_Line_DineIn
  Scenario: Basic_Order_Entry_Dine_In_Cash_With_Changed_Due_With_PM_Enabled_Testcase
