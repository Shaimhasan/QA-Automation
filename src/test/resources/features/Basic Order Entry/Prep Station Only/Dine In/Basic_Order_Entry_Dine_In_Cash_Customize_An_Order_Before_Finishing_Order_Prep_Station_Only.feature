Feature: Basic Order Entry - Customize an order before finishing order - with Prep Station Only
  ...
  @Basic_Order_Entry_Dine_In_Cash_Customize_An_Order_Before_Finishing_Order_Prep_Station_Only @RegressionSuite @DineIn @BOE @BOE_Prep_Station_Only @BOE_Prep_Station_Only_DineIn
