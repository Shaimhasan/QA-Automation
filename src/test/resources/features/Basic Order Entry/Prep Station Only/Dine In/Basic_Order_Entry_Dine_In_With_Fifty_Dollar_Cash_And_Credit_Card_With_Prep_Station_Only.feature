Feature: Basic Order Entry - Dine-in with cash and Credit Card  - with Prep Station Only
  ...
  @Basic_Order_Entry_Dine_In_With_Fifty_Dollar_Cash_And_Credit_Card_With_Prep_Station_Only @RegressionSuite @BOE @BOE_Prep_Station_Only @BOE_Prep_Station_Only_DineIn
