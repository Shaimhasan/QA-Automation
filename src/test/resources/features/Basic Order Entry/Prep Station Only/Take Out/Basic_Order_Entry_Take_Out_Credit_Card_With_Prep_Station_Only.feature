Feature: Basic Order Entry - Take Out Credit Card  - with Prep Station Only
  This script is to validate Basic Order Entry - Take Out Credit Card  - with Prep Station Only

  @Basic_Order_Entry_Take_Out_Credit_Card_With_Prep_Station_Only @RegressionSuite @TakeOut @BOE_TakeOut @BOE @BOE_Prep_Station_Only @BOE_Prep_Station_Only_TakeOut
  Scenario: Basic_Order_Entry_Take_Out_Credit_Card_With_Prep_Station_Only_Testcase
