Feature: Basic Order Entry - Customize an order before finishing order - with all lines disabled
  ...
  @Basic_Order_Entry_Dine_In_Cash_Customize_An_Order_Before_Finishing_Order_With_ALD @RegressionSuite @DineIn @BOE_DineIn @BOE @BOE_ALD @BOE_ALD_DineIn
  Scenario: Basic_Order_Entry_Dine_In_Cash_Customize_An_Order_Before_Finishing_Order_With_ALD_Testcase
