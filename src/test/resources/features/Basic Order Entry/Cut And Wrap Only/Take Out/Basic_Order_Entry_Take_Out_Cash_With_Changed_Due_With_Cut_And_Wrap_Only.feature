Feature: Basic Order Entry - Take Out Cash - with Change Due  - with Cut and Wrap Only
  ...
  @Basic_Order_Entry_Take_Out_Cash_With_Changed_Due_With_Cut_And_Wrap_Only @RegressionSuite @TakeOut @BOE @BOE_Cut_And_Wrap_Only @BOE_BOE_Cut_And_Wrap_Only_TakeOut
