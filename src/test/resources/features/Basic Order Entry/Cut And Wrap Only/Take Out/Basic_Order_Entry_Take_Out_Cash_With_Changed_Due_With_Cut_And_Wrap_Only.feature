Feature: Basic Order Entry - Take Out Cash - with Change Due  - with Cut and Wrap Only
  This script is to validate Basic Order Entry - Take Out Cash - with Change Due  - with Cut and Wrap Only with 100$ Cash

  @Basic_Order_Entry_Take_Out_Cash_With_Changed_Due_With_Cut_And_Wrap_Only @RegressionSuite @TakeOut @BOE_TakeOut @BOE @BOE_Cut_And_Wrap_Only @BOE_BOE_Cut_And_Wrap_Only_TakeOut @Smoke_Testing
  Scenario: Basic_Order_Entry_Take_Out_Cash_With_Changed_Due_With_Cut_And_Wrap_Only_Testcase
