Feature: Basic Order Entry - Dine-in with cash and Credit Card  - with Cut and Wrap Only
  ...
  @Basic_Order_Entry_Dine_In_With_Fifty_Dollar_Cash_And_Credit_Card_With_Cut_And_Wrap_Only @RegressionSuite @DineIn @BOE_DineIn @BOE @BOE_Cut_And_Wrap_Only @BOE_BOE_Cut_And_Wrap_Only_DineIn
