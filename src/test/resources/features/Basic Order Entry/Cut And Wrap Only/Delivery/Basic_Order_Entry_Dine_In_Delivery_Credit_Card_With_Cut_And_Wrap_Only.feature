Feature: Basic Order Entry - Delivery Credit Card  - with Cut and Wrap Only
  ...
  @Basic_Order_Entry_Dine_In_Delivery_Credit_Card_With_Cut_And_Wrap_Only @RegressionSuite @Delivery @BOE @BOE_Cut_And_Wrap_Only @BOE_BOE_Cut_And_Wrap_Only_Delivery
