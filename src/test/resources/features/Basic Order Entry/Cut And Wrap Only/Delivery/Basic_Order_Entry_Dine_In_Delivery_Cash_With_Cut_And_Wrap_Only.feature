Feature: Basic Order Entry - Delivery Cash  - with Cut and Wrap Only
  This script is to validate Basic Order Entry - Delivery Cash  - with Cut and Wrap Only

  @Basic_Order_Entry_Dine_In_Delivery_Cash_With_Cut_And_Wrap_Only @RegressionSuite @Delivery @BOE_Delivery @BOE @BOE_Cut_And_Wrap_Only @BOE_BOE_Cut_And_Wrap_Only_Delivery
  Scenario: Basic_Order_Entry_Dine_In_Delivery_Cash_With_Cut_And_Wrap_Only_Testcase
