Feature: Basic Edit Advertisements
  This script is to validate Edit Advertisements

  @Basic_Edit_Advertisements @RegressionSuite @BO_Advertisements @Discounts @Back_Office @Smoke_Testing
  Scenario: Basic_Edit_Advertisements_Testcase
    ...
    #Comment: the user edit the cost
    And the user enters random number into the "cost" textbox at the "EditAdvertisementsPage" page and store at dictionary key "cost_value2"
    #Comment: the user edit the quantity
    And the user enters random number into the "quantity" textbox at the "EditAdvertisementsPage" page and store at dictionary key "quantity_value2"
    #Cooment: the user click save
    And the user clicks the "save" element at the "AddAdvertisementsPage" page
    #Comment: The user wait until page is loading
    And the user waits for the page to load
    #Comment: the user click on the ID number row
    And the user clicks the "table" element with dictionary key "#(name_value2)" at the "AdvertisementsPage" page with xpath1 "#(IdNumberXpath1)" and xpath2 "#(IdNumberXpath2)"
    #Comment: the user store the id
    And store the displayed text of the "table" element at the "AdvertisementsPage" page and get the dictionary key value "#(name_value2)" based on xpath1 "#(IdNumberXpath1)" and xpath2 "#(IdNumberXpath2)" store at dictionary with key "Id_Number"
    #Comment: the user click on Edit Button
    And the user clicks the "editBtn" element at the "AdvertisementsPage" page
    #Comment: the user validate the visibility of popup
    And the user waits for the "advertisementsTxtPopup" element to be "VISIBLE" on the "EditAdvertisementsPage" page
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "name" element at the "EditAdvertisementsPage" page into the data dictionary with key "name_value3"
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "cost" element at the "EditAdvertisementsPage" page into the data dictionary with key "cost_value3"
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "quantity" element at the "EditAdvertisementsPage" page into the data dictionary with key "quantity_value3"
    #Comment: user validate Name US Value
    And the user validates the data dictionary value of "#(name_value2)" is "Equal To" data dictionary value of "#(name_value3)" "validate_nameUS_value" "HardStopOnFailure"
    #Comment: user validate descriptionSpanish Value
    And the user validates the data dictionary value of "#(cost_value2)" is "Equal To" data dictionary value of "#(cost_value3)" "validate_descriptionSpanish_value" "HardStopOnFailure"
    #Comment: user validate descriptionSpanish Value
