Feature: Basic Edit SingleUseCoupons
  ...
  @Basic_Edit_SingleUseCoupons @RegressionSuite @BO_SingleUseCoupons @Discounts @Back_Office @Smoke_Testing
  Scenario: Basic_Edit_SingleUseCoupons_Testcase
    ...
    #Cooment: the user click save
    And the user clicks the "save" element at the "EditSingleUseCouponsPage" page
    #Comment: The user wait until page is loading
    And the user waits for the page to load
    #Comment: the user click on the ID number row
    And the user clicks the "table" element with dictionary key "#(name_value2)" at the "SingleUseCouponsPage" page with xpath1 "#(IdNumberXpath1)" and xpath2 "#(IdNumberXpath2)"
    #Comment: the user store the id
    And store the displayed text of the "table" element at the "SingleUseCouponsPage" page and get the dictionary key value "#(name_value2)" based on xpath1 "#(IdNumberXpath1)" and xpath2 "#(IdNumberXpath2)" store at dictionary with key "Id_Number"
    #Comment: the user click on Edit Button
    And the user clicks the "editBtn" element at the "SingleUseCouponsPage" page
    #Comment: the user validate the visibility of popup
    And the user waits for the "singleUseCouponsTxtPopup" element to be "VISIBLE" on the "EditSingleUseCouponsPage" page
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "name" element at the "EditSingleUseCouponsPage" page into the data dictionary with key "name_value3"
    #Comment: user validate Name US Value
    And the user validates the data dictionary value of "#(name_value2)" is "Equal To" data dictionary value of "#(name_value3)" "validate_name_value" "HardStopOnFailure"
