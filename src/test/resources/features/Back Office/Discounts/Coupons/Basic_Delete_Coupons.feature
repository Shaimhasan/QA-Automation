Feature: Basic Delete Coupons
  ...
  @Basic_Delete_Coupons @RegressionSuite @BO_Coupons @Discounts @Back_Office
  Scenario: Basic_Delete_Coupons_Testcase
...
#    And the user enters "2" days after with current date into the "endDate" textbox at the "AddCouponsPage" page
    ...
    And the user validates and append at leading any value ": " with data dictionary key "#(nameUS_value1)" and store with new dictionary key "name_value1_Latest"
    #Comment append value with dictionary
