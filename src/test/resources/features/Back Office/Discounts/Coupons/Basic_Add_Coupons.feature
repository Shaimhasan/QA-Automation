Feature: Basic Add Coupons
  ...
  Scenario: Basic_Add_Coupons_Testcase
    ...
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "couponNumber" element at the "AddCouponsPage" page into the data dictionary with key "couponNumber_value2"
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "discount" element at the "AddCouponsPage" page into the data dictionary with key "discount_value2"
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "backGroundColor" element at the "AddCouponsPage" page into the data dictionary with key "backGroundColor_value2"
