Feature: Basic Cancel Delete Tax Definitions
  This script is to validate Cancel Delete Tax Definitions

  @Basic_Cancel_Delete_Tax_Definitions @RegressionSuite @BO_Tax_Definitions @Settings @Back_Office
  Scenario: Basic_Cancel_Delete_Tax_Definitions_Testcase
    ...
    And the user clicks the "cancelOnWarning" element at the "TaxDefinitionsPage" page
