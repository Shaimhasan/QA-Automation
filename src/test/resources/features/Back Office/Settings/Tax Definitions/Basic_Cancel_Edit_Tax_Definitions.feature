Feature: Basic Cancel Edit Tax Definitions
  This script is to validate Cancel Edit Tax Definitions

  @Basic_Cancel_Edit_Tax_Definitions @RegressionSuite @BO_Tax_Definitions @Settings @Back_Office
  Scenario: Basic_Cancel_Edit_Tax_Definitions_Testcase
    ...
    #Cooment: the user clicks on the Save button
    ...
    #Comment: the user click on the name row
    ...
    #Comment: the user validate the visibility of popup
    And the user waits for the "taxDefinitionsTxtPopup" element to be "VISIBLE" on the "AddTaxDefinitionsPage" page
    #Comment: the user enters a new name On Add Tax Definitions
    And the user enters dynamic UserName "#(nameUS)" into the "nameUS" textbox at the "AddTaxDefinitionsPage" page
    #Comment: the user enters a new value in Fixed Amount
    And the user enters "#(fixedAmtUpdated)" into the "fixedAmt" textbox at the "AddTaxDefinitionsPage" page
    #Comment: the user click on the Cancel button
    ...
    And the user waits for the "delete" element to be "DISABLED" on the "TaxDefinitionsPage" page