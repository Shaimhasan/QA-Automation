Feature: Basic Delete Tax Definitions
  This script is to validate Delete Tax Definitions

  @Basic_Delete_Tax_Definitions @RegressionSuite @BO_Tax_Definitions @Settings @Back_Office
  Scenario: Basic_Delete_Tax_Definitions_Testcase
