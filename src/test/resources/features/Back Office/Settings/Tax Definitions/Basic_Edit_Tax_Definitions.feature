Feature: Basic Edit Tax Definitions
  This script is to validate Edit Tax Definitions

  @Basic_Edit_Tax_Definitions @RegressionSuite @BO_Tax_Definitions @Back_Office @Settings
  Scenario: Basic_Edit_Tax_Definitions_Testcase
    ...
    And the user enters dynamic UserName "#(nameSpanish)" into the "nameSpanish" textbox at the "AddTaxDefinitionsPage" page
    #Comment: the user store the text on data dictionary
    ...
    #Comment: the user validate the visibility of popup
    And the user waits for the "taxDefinitionsTxtPopup" element to be "VISIBLE" on the "EditTaxDefinitionsPage" page
    #Comment: the user enters the name On ADD Tax Definition
    And the user enters dynamic UserName "#(nameUS)" into the "nameUS" textbox at the "EditTaxDefinitionsPage" page
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "nameUS" element at the "EditTaxDefinitionsPage" page into the data dictionary with key "nameUS_value1_Updated_1"
    #Comment: the user enters the name Spanish
    And the user enters dynamic UserName "#(nameSpanish)" into the "nameSpanish" textbox at the "AddTaxDefinitionsPage" page
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "nameSpanish" element at the "EditTaxDefinitionsPage" page into the data dictionary with key "nameSpanish_value1_Updated_1"
    #Cooment: the user click save
    And the user clicks the "save" element at the "EditTaxDefinitionsPage" page
    #Comment: The user wait until page is loading
    And the user waits for the page to load
    #Comment: the user click on the ID number row
    ...
    And the user waits for the page to load
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "nameUS" element at the "EditTaxDefinitionsPage" page into the data dictionary with key "nameUS_value2_Updated_2"
    ...
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "nameSpanish" element at the "EditTaxDefinitionsPage" page into the data dictionary with key "nameSpanish_value2_Updated_2"
