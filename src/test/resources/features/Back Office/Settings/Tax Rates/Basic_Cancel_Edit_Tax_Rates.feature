Feature: Basic Cancel Edit Tax Rates
  This script is to validate Cancel Edit Tax Rates

  @Basic_Cancel_Edit_Tax_Rates @RegressionSuite @BO_Tax_Rates @Settings @Back_Office
  Scenario: Basic_Cancel_Edit_Tax_Rates_Testcase
