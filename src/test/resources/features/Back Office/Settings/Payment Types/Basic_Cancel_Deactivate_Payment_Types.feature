Feature: Basic Cancel Deactivate Payment Types
  This script is to validate Cancel Deactivate Payment Types

  @Basic_Cancel_Deactivate_Payment_Types @RegressionSuite @BO_Payment_Types @Settings @Back_Office
  Scenario: Basic_Cancel_Deactivate_Payment_Types_Testcase
