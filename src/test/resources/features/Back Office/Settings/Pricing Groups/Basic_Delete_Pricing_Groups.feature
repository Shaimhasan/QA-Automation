Feature: Basic Delete Pricing Groups
  This script is to validate Delete Pricing Groups

  @Basic_Delete_Pricing_Groups @RegressionSuite @BO_Pricing_Groups @Settings @Back_Office
  Scenario: Basic_Delete_Pricing_Groups_Testcase
