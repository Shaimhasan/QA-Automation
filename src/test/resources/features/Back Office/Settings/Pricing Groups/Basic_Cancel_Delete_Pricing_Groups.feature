Feature: Basic Cancel Delete Pricing Groups
  This script is to validate Cancel Delete Pricing Groups

  @Basic_Cancel_Delete_Pricing_Groups @RegressionSuite @BO_Pricing_Groups @Settings @Back_Office
  Scenario: Basic_Cancel_Delete_Pricing_Groups_Testcase
    ...
    And the user clicks the "cancelOnWarning" element at the "PricingGroupsPage" page
