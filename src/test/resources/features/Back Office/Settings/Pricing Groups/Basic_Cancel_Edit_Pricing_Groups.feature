Feature: Basic Cancel Edit Pricing Groups
  This script is to validate Cancel Edit Pricing Groups

  @Basic_Cancel_Edit_Pricing_Groups @RegressionSuite @BO_Pricing_Groups @Settings @Back_Office
  Scenario: Basic_Cancel_Edit_Pricing_Groups_Testcase
    ...
    And the user waits for the "delete" element to be "DISABLED" on the "PricingGroupsPage" page