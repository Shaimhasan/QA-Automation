Feature: Basic Add Inventory Items
  This script is to validate Add Inventory Items

  @Basic_Add_Inventory_Items @RegressionSuite @BO_Inventory_Items @Inventory @Back_Office
  Scenario: Basic_Add_Inventory_Items_Testcase
    ...
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "conversionFactor" element at the "EditInventoryItemsPage" page into the data dictionary with key "conversionFactor_value2"
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "InvUnitConFactor" element at the "EditInventoryItemsPage" page into the data dictionary with key "InvUnitConFactor_value2"
