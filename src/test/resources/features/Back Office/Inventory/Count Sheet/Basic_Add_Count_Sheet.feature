Feature: Basic Add Count Sheet
  ...
  @Basic_Add_Count_Sheet @RegressionSuite @BO_Count_Sheet @Back_Office
  Scenario: Basic_Add_Count_Sheet_Testcase
    ...
    #Comment: the user validate the drop down value selected
    And the user selects value from the "frequency" dropdown equal to given value "Weekly" at the "EditCountSheetPage" page
    #Comment: the user validate the drop down value selected
    And the user selects value from the "location" dropdown equal to given value "Freezer" at the "EditCountSheetPage" page
    #Comment: the user validate check box selected
    And the user validates the item in the "allItems" checkbox is checked at the "EditCountSheetPage" page "validate_checkbox_Selected" "HardStopOnFailure"
    #Comment: the user validate check box selected
