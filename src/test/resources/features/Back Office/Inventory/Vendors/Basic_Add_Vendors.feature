Feature: Basic Add Vendors
  ...
  @Basic_Add_Vendors @RegressionSuite @BO_Vendors @Inventory @Back_Office
  Scenario: Basic_Add_Vendors_Testcase
    ...
    #Comment : the User stores the value
    And store the displayed text of the "phoneNo" element at the "AddVendorsPage" page into the data dictionary with key "phoneNo_value1"
    ...
    #Comment: the user click Add vendors
    And the user clicks the "editBtn" element at the "VendorsPage" page
    #Comment: the user validate the visibility of popup
    And the user waits for the "vendorTxt" element to be "VISIBLE" on the "EditVendorsPage" page
    #Comment : the User stores the value
    And store the displayed text of the "name" element at the "EditVendorsPage" page into the data dictionary with key "name_value2"
    #Comment : the User stores the value
    And store the displayed text of the "phoneNo" element at the "EditVendorsPage" page into the data dictionary with key "phoneNo_value2"
    #Comment : the User stores the email
    And store the displayed text of the "email" element at the "EditVendorsPage" page into the data dictionary with key "email_value2"
    #Comment : the User stores the value
    And store the displayed text of the "address" element at the "EditVendorsPage" page into the data dictionary with key "address_value2"
    #Comment : the User stores the city
    And store the displayed text of the "city" element at the "EditVendorsPage" page into the data dictionary with key "city_value2"
    #Comment : the User stores the zipCode
    And store the displayed text of the "zipCode" element at the "EditVendorsPage" page into the data dictionary with key "zipCode_value2"
    #Comment : the User validates the value
    And the user validates the data dictionary value of "#(name_value1)" is "Equal To" data dictionary value of "#(name_value2)" "validate_value" "HardStopOnFailure"
    #Comment : the User validates the value
    And the user validates the data dictionary value of "#(phoneNo_value1)" is "Equal To" data dictionary value of "#(phoneNo_value2)" "validate_value" "HardStopOnFailure"
    #Comment : the User validates the value
    And the user validates the data dictionary value of "#(email_value1)" is "Equal To" data dictionary value of "#(email_value2)" "validate_value" "HardStopOnFailure"
    #Comment : the User validates the value
    And the user validates the data dictionary value of "#(address_value1)" is "Equal To" data dictionary value of "#(address_value2)" "validate_value" "HardStopOnFailure"
    #Comment : the User validates the value
    And the user validates the data dictionary value of "#(city_value1)" is "Equal To" data dictionary value of "#(city_value2)" "validate_value" "HardStopOnFailure"
    #Comment : the User validates the value
    And the user validates the data dictionary value of "#(zipCode_value1)" is "Equal To" data dictionary value of "#(zipCode_value2)" "validate_value" "HardStopOnFailure"
    #Comment : the User click on Cancel
    And the user clicks the "cancel" element at the "EditVendorsPage" page
