Feature: Basic Activate Vendors
  ...
  @Basic_Activate_Vendors @RegressionSuite @BO_Vendors
  Scenario: Basic_Activate_Vendors_Testcase
    ...
    #Comment: The user validate the chages on Hisotry Page
    And the user validates the cell at row "1" and column "2" of the "tableDetails" table at the "HistoryPage" page "Equal To" "False" "validate_InvoiceNumber_Details" "HardStopOnFailure"
    #Comment: The user validate the chages on Hisotry Page
    And the user validates the cell at row "1" and column "3" of the "tableDetails" table at the "HistoryPage" page "Equal To" "True" "validate_InvoiceNumber_Details" "HardStopOnFailure"
