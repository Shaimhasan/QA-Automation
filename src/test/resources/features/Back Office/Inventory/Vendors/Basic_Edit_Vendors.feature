Feature: Basic Edit Vendors
  ...
  @Basic_Edit_Vendors @RegressionSuite @BO_Vendors @Inventory @Back_Office @Smoke_Testing
  Scenario: Basic_Edit_Vendors_Testcase
    ...
    #Comment : the User enters dynamic name
    And the user enters dynamic UserName "#(name)" into the "name" textbox at the "EditVendorsPage" page
    #Comment : the User stores the value
    ...
    And the user waits for the page to load
    #Comment: the user click on the ID number row
    And the user clicks the "table" element with dictionary key "#(name_value2)" at the "VendorsPage" page with xpath1 "#(IdNumberXpath1)" and xpath2 "#(IdNumberXpath2)"
    #Comment: the user store the id
    And store the displayed text of the "table" element at the "VendorsPage" page and get the dictionary key value "#(name_value2)" based on xpath1 "#(IdNumberXpath1)" and xpath2 "#(IdNumberXpath2)" store at dictionary with key "Id_Number"
    #Comment: the user click Add vendors
    And the user clicks the "editBtn" element at the "VendorsPage" page
    #Comment: the user validate the visibility of popup
    And the user waits for the "vendorTxt" element to be "VISIBLE" on the "EditVendorsPage" page
    #Comment : the User stores the value
    And store the displayed text of the "name" element at the "EditVendorsPage" page into the data dictionary with key "name_value3"
    #Comment : the User validates the value
    And the user validates the data dictionary value of "#(name_value2)" is "Equal To" data dictionary value of "#(name_value3)" "validate_value" "HardStopOnFailure"
