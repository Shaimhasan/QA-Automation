Feature: Basic Edit Mixtures Prep
  ...
  @Basic_Edit_Mixtures_Prep @RegressionSuite @BO_Mixtures_Prep @Inventory @Back_Office @Smoke_Testing
  Scenario: Basic_Edit_Mixtures_Prep_Testcase
    ...
    And the user clicks the "editBtn" element at the "MixturesPrepPage" page
    #Comment: the user validate the visibility of popup
    And the user waits for the "mixturesPrepTxtPopup" element to be "VISIBLE" on the "EditMixturesPrepPage" page
    #Comment: the user enter random number
    And the user enters random number based on Digit "900" into the "making" textbox at the "EditMixturesPrepPage" page and store at dictionary key "making_value2"
    #Cooment: the user click save
    And the user clicks the "save" element at the "EditMixturesPrepPage" page
    #Comment: The user wait until page is loading
    And the user waits for the page to load
    #Comment: the user click on the ID number row
    And the user clicks the "table" element with dictionary key "#(making_value2)" at the "MixturesPrepPage" page with xpath1 "#(IdNumberXpath1)" and xpath2 "#(IdNumberXpath2)"
    #Comment: the user store the id
    And store the displayed text of the "table" element at the "MixturesPrepPage" page and get the dictionary key value "#(making_value2)" based on xpath1 "#(IdNumberXpath1)" and xpath2 "#(IdNumberXpath2)" store at dictionary with key "Id_Number"
    #Comment: the user click on Edit Button
    And the user clicks the "editBtn" element at the "MixturesPrepPage" page
    #Comment: the user validate the visibility of popup
    And the user waits for the "mixturesPrepTxtPopup" element to be "VISIBLE" on the "EditMixturesPrepPage" page
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "date" element at the "EditMixturesPrepPage" page into the data dictionary with key "date_value2"
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "making" element at the "EditMixturesPrepPage" page into the data dictionary with key "making_value3"
    #Comment: user validate Name US Value
    And the user validates the data dictionary value of "#(making_value2)" is "Equal To" data dictionary value of "#(making_value3)" "validate_invoiceNum_value" "HardStopOnFailure"
    ...
    And the user clicks the "cancelBtn" element at the "EditMixturesPrepPage" page
    ...
    #Comment append value with dictionary
    And the user validates and append at trailing any value "']//preceding-sibling::td[text()='Edit']//following-sibling::td)[5]" with data dictionary key "#(automationMix_Latest)" and store with new dictionary key "automationMix_Latest_1"
    #Comment: the user click on Details Elements
    And the user clicks the "table" element with dictionary key "#(Id_Number)" at the "HistoryPage" page with xpath1 "#(DetailsClickXpath1)" and xpath2 "#(automationMix_Latest_1)"
    ...
    And the user validates the cell at row "1" and column "0" of the "tableDetails" table at the "HistoryPage" page "Equal To" "Making" "validate_Item_Changed_Details" "HardStopOnFailure"
    #Comment: The user validate the chages on Hisotry Page
    ...
    #Comment: The user validate the chages on Hisotry Page
    And the user validates the cell at row "1" and column "2" of the "tableDetails" table at the "HistoryPage" page "Equal To" "#(making_value1)" "validate_InvoiceNumber_Details" "HardStopOnFailure"
    #Comment: The user validate the chages on Hisotry Page
    And the user validates the cell at row "1" and column "3" of the "tableDetails" table at the "HistoryPage" page "Equal To" "#(making_value2)" "validate_InvoiceNumber_Details" "HardStopOnFailure"
