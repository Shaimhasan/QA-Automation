Feature: Basic Edit Sizes
  This script is to validate Edit Sizes

  @Basic_Edit_Sizes @RegressionSuite @BO_Sizes @Menu_Settings @Back_Office @Smoke_Testing
  Scenario: Basic_Edit_Sizes_Testcase
    ...
    And the user waits for the "sizeTxt" element to be "VISIBLE" on the "SizesPage" page
    ...
    #Comment: the user enters the name On ADD Item
    And the user enters dynamic UserName "#(nameUS)" into the "nameUS" textbox at the "EditSizesPage" page
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "nameUS" element at the "EditSizesPage" page into the data dictionary with key "nameUS_value1_Updated_1"
    #Cooment: the user click save
    And the user clicks the "save" element at the "EditSizesPage" page
    #Comment: The user wait until page is loading
    And the user waits for the dom to load
    #Comment: the user click on the ID number row
    And the user clicks the "table" element with dictionary key "#(nameUS_value1_Updated_1)" at the "SizesPage" page with xpath1 "#(IdNumberXpath1)" and xpath2 "#(IdNumberXpath2)"
    #Comment: the user click on Edit Button
    And the user clicks the "editBtn" element at the "SizesPage" page
    #Comment: The user wait until page is loading
    And the user waits for the dom to load
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "nameUS" element at the "EditSizesPage" page into the data dictionary with key "nameUS_value2_Updated_2"
