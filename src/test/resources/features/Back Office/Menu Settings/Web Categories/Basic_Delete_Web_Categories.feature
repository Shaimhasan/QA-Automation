Feature: Basic Delete Web Categories
  ...
  @Basic_Delete_Web_Categories @RegressionSuite @BO_Web_Categories @Menu_Settings @Back_Office
  Scenario: Basic_Delete_Web_Categories_Testcase
   ...
   #Comment: the user click on Delete Button
    ...
    And the user waits for the "delete" element to be "DISABLED" on the "WebCategoriesPage" page
