Feature: Basic Add Web Categories
  This script is to validate Add Web Categories

  @Basic_Add_Web_Categories @RegressionSuite @BO_Web_Categories @Menu_Settings @Back_Office
  Scenario: Basic_Add_Web_Categories_Testcase
    ...
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "descriptionUS" element at the "EditWebCategoriesPage" page into the data dictionary with key "descriptionUS_value2"
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "nameSpanish" element at the "EditWebCategoriesPage" page into the data dictionary with key "nameSpanish_value2"
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "descriptionSpanish" element at the "EditWebCategoriesPage" page into the data dictionary with key "descriptionSpanish_value2"
    ...
    And the user validates the "Active" item in the "activeCheckBoxIsSelected" checkbox is checked at the "EditWebCategoriesPage" page "validate_CheckBx_Selected" "HardStopOnFailure"
