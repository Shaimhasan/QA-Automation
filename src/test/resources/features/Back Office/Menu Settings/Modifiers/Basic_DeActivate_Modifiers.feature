Feature: Basic DeActivate Modifiers
  ...
  @Basic_DeActivate_Modifiers @RegressionSuite @BO_Modifires @Back_Office
  Scenario: Basic_DeActivate_Modifiers_Testcase
    ...
    And the user clicks the "activeChkBx" element at the "ActDeactModifiersPage" page
    #Comment: user validate the check box is selected
    And the user validates the item in the "activeChkBxIsSelected" checkbox is Not checked at the "ActDeactModifiersPage" page "validate_CheckBx_Selected" "HardStopOnFailure"
    #Comment: the user click save Button
    And the user clicks the "save" element at the "ActDeactModifiersPage" page
    #Comment: The user wait until page is loading
    And the user waits for the page to load
    ...
    #Comment: The user validate the chages on Hisotry Page
    And the user validates the cell at row "2" and column "2" of the "tableDetails" table at the "HistoryPage" page "Equal To" "True" "validate_Item_Changed_Details" "HardStopOnFailure"
    #Comment: The user validate the chages on Hisotry Page
    And the user validates the cell at row "2" and column "3" of the "tableDetails" table at the "HistoryPage" page "Equal To" "False" "validate_Item_Changed_Details" "HardStopOnFailure"
