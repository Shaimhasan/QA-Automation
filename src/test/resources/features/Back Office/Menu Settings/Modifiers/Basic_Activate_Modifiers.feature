Feature: Basic Activate Modifiers
  ...
  Scenario: Basic_Activate_Modifiers_Testcase
    ...
    And the user clicks the "actAndDeact" element at the "ModifiersPage" page
    #Comment: the user validate the visibility of popup
    And the user waits for the "modifiersTextVal" element to be "VISIBLE" on the "ActDeactModifiersPage" page
    #Comment: the user select the availbale check box
    And the user clicks the "availabelChkBox" element at the "ActDeactModifiersPage" page
    #Comment: user validate the check box is selected
    And the user validates the item in the "availabelChkBoxIsSelected" checkbox is checked at the "ActDeactModifiersPage" page "validate_CheckBx_Selected" "HardStopOnFailure"
    #Comment: the user select the availbale check box
    And the user clicks the "activeChkBx" element at the "ActDeactModifiersPage" page
    #Comment: user validate the check box is selected
    And the user validates the item in the "activeChkBxIsSelected" checkbox is checked at the "ActDeactModifiersPage" page "validate_CheckBx_Selected" "HardStopOnFailure"
    #Comment: the user click save Button
    And the user clicks the "save" element at the "ActDeactModifiersPage" page
    #Comment: The user wait until page is loading
    And the user waits for the page to load
    #Comment: the user click on the ID number row
    And the user clicks the "table" element with dictionary key "#(nameUS_value1)" at the "ModifiersPage" page with xpath1 "#(IdNumberXpath1)" and xpath2 "#(IdNumberXpath2)"
    ...
    And the user validates the item in the "activeChkBxIsSelected" checkbox is checked at the "ActDeactModifiersPage" page "validate_CheckBx_Selected" "HardStopOnFailure"
    #Comment: the user click on Edit Button
    And the user clicks the "cancel" element at the "ActDeactModifiersPage" page
    ...
    #Comment: The user validate the chages on Hisotry Page
    And the user validates the cell at row "1" and column "2" of the "tableDetails" table at the "HistoryPage" page "Equal To" "False" "validate_Item_Changed_Details" "HardStopOnFailure"
    #Comment: The user validate the chages on Hisotry Page
    And the user validates the cell at row "1" and column "3" of the "tableDetails" table at the "HistoryPage" page "Equal To" "True" "validate_Item_Changed_Details" "HardStopOnFailure"
    #Comment: The user validate the chages on Hisotry Page
    And the user validates the cell at row "2" and column "0" of the "tableDetails" table at the "HistoryPage" page "Equal To" "Available" "validate_Item_Changed_Details" "HardStopOnFailure"
    #Comment: The user validate the chages on Hisotry Page
    ...
    #Comment: The user validate the chages on Hisotry Page
    And the user validates the cell at row "2" and column "2" of the "tableDetails" table at the "HistoryPage" page "Equal To" "False" "validate_Item_Changed_Details" "HardStopOnFailure"
    #Comment: The user validate the chages on Hisotry Page
    And the user validates the cell at row "2" and column "3" of the "tableDetails" table at the "HistoryPage" page "Equal To" "True" "validate_Item_Changed_Details" "HardStopOnFailure"
