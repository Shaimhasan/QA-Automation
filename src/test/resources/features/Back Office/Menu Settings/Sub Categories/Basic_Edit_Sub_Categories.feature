Feature: Basic Edit Sub Categories
  ...
  @Basic_Edit_Sub_Categories @RegressionSuite @BO_Sub_Categories @Menu_Settings @Back_Office @Smoke_Testing
  Scenario: Basic_Edit_Sub_Categories_Testcase
    ...
    #Comment: the user store the value
    ...
    #Comment: the user enter name spanish
