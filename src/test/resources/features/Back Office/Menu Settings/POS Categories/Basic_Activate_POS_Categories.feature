Feature: Basic Activate POS Categories
  This script is to validate Activate POC Categories

  @Basic_Activate_POS_Categories @RegressionSuite @BO_POS_Categories @Menu_Settings @Back_Office
  Scenario: Basic_Activate_POS_Categories_Testcase
    ...
    And the user waits for the "posCatText" element to be "VISIBLE" on the "AddPOSCategoriesPage" page
    ...
    #Comment: the user enter the desc
    ...
    And the user clicks the "actAndDeact" element at the "POSCategoriesPage" page
    #Comment: the user validate the visibility of popup
    And the user waits for the "posCatTextPopUp" element to be "VISIBLE" on the "ActivateDeActicatePOSCategoriesPage" page
    ...
    And the user validates the item in the "availabelChkBoxIsSelected" checkbox is checked at the "ActivateDeActicatePOSCategoriesPage" page "validate_CheckBx_Selected" "HardStopOnFailure"
    #Comment: the user click on Edit Button
    And the user clicks the "cancel" element at the "ActivateDeActicatePOSCategoriesPage" page
