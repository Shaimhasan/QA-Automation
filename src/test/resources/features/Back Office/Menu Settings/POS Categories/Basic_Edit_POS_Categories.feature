Feature: Basic Edit POS Categories
  This script is to validate Edit POC Categories

  @Basic_Edit_POS_Categories @RegressionSuite @BO_POS_Categories @Menu_Settings @Back_Office @Smoke_Testing
  Scenario: Basic_Edit_POS_Categories_Testcase
    ...
    And the user waits for the "posCatTextPopUp" element to be "VISIBLE" on the "AddPOSCategoriesPage" page
    #Comment: the user enters the name On ADD Item
    And the user enters dynamic UserName "#(nameUS)" into the "nameUS" textbox at the "EditPOSCategoriesPage" page
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "nameUS" element at the "AddPOSCategoriesPage" page into the data dictionary with key "nameUS_value1_Updated_1"
    #Comment: the user unselect the actiiveChkBx check box
    And the user clicks the "actiiveChkBx" element at the "AddPOSCategoriesPage" page
    #Comment: the user select the dropdown values Merged Categories
    ...
    And the user waits for the page to load
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "nameUS" element at the "AddPOSCategoriesPage" page into the data dictionary with key "nameUS_value2_Updated_2"
    ...
    #Comment: the user validate the checkbox not selected
    And the user validates the item in the "activeCheckBoxIsSelectedValidate" checkbox is Not checked at the "EditPOSCategoriesPage" page "validate_CheckBx_Selected" "HardStopOnFailure"
    #Comment: the user validate the selected value
    And the user selects value from the "selectMergeCatDrpDwn" dropdown equal to given value "Appetizer" at the "EditPOSCategoriesPage" page
    ...
    #Comment: The user validate the chages on Hisotry Page
    And the user validates the cell at row "2" and column "0" of the "tableDetails" table at the "HistoryPage" page "Equal To" "Merged Categories" "validate_Item_Changed_Details" "HardStopOnFailure"
    #Comment: The user validate the chages on Hisotry Page
    ...
    #Comment: The user validate the chages on Hisotry Page
    And the user validates the cell at row "2" and column "2" of the "tableDetails" table at the "HistoryPage" page "Equal To" "Pizza" "validate_Item_Changed_Details" "HardStopOnFailure"
    #Comment: The user validate the chages on Hisotry Page
    And the user validates the cell at row "2" and column "3" of the "tableDetails" table at the "HistoryPage" page "Equal To" "Appetizer" "validate_Item_Changed_Details" "HardStopOnFailure"

    #Comment: The user validate the chages on Hisotry Page
    And the user validates the cell at row "3" and column "0" of the "tableDetails" table at the "HistoryPage" page "Equal To" "Name: English - United States - Text" "validate_Item_Changed_Details" "HardStopOnFailure"
    #Comment: The user validate the chages on Hisotry Page
    ...
    #Comment: The user validate the chages on Hisotry Page
    And the user validates the cell at row "3" and column "2" of the "tableDetails" table at the "HistoryPage" page "Equal To" "#(nameUS_value1)" "validate_Item_Changed_Details" "HardStopOnFailure"
    #Comment: The user validate the chages on Hisotry Page
    And the user validates the cell at row "3" and column "3" of the "tableDetails" table at the "HistoryPage" page "Equal To" "#(nameUS_value1_Updated_1)" "validate_Item_Changed_Details" "HardStopOnFailure"
