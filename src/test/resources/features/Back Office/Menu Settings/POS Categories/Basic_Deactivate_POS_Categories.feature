Feature: Basic Deactivate POS Categories
  ...
  @Basic_Deactivate_POS_Categories @RegressionSuite @BO_POS_Categories @Back_Office
  Scenario: Basic_Deactivate_POS_Categories_Testcase
    ...
    #Comment: the user validate the visibility of popup
    And the user waits for the "posCatTextPopUp" element to be "VISIBLE" on the "ActivateDeActicatePOSCategoriesPage" page
    #Comment: user validate the checkbox
    And the user validates the item in the "availabelChkBoxIsSelected" checkbox is Not checked at the "ActivateDeActicatePOSCategoriesPage" page "validate_CheckBx_Selected" "HardStopOnFailure"
    #Comment: the user click on Edit Button
