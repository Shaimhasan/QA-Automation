Feature: Basic Edit Modifier POS Categories
  This script is to validate Edit Modifier POC Categories

  @Basic_Edit_Modifier_POS_Categories @RegressionSuite @BO_Modifier_POS_Categories @Back_Office
  Scenario: Basic_Edit_Modifier_POS_Categories_Testcase
    ...
    #Comment: the user validate the visibility of popup
    And the user waits for the "modifierPOSCatTextPopUp" element to be "VISIBLE" on the "EditModifierPOSCategoriesPage" page
    #Comment: the user enters the name On ADD Item
    And the user enters dynamic UserName "#(nameUS)" into the "nameUS" textbox at the "EditModifierPOSCategoriesPage" page
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "nameUS" element at the "EditModifierPOSCategoriesPage" page into the data dictionary with key "nameUS_value1_Updated_1"
    #Cooment: the user click save
    ...
    And the user clicks the "cancelBtn" element at the "EditModifierPOSCategoriesPage" page
    ...
    And the user validates the cell at row "0" and column "0" of the "tableDetails" table at the "HistoryPage" page "Equal To" "Name: English - United States - Text" "validate_Item_Changed_Details" "HardStopOnFailure"
    #Comment: The user validate the chages on Hisotry Page
    ...
    #Comment: The user validate the chages on Hisotry Page
    And the user validates the cell at row "0" and column "2" of the "tableDetails" table at the "HistoryPage" page "Equal To" "#(nameUS_value1)" "validate_Item_Changed_Details" "HardStopOnFailure"
    #Comment: The user validate the chages on Hisotry Page
    And the user validates the cell at row "0" and column "3" of the "tableDetails" table at the "HistoryPage" page "Equal To" "#(nameUS_value1_Updated_1)" "validate_Item_Changed_Details" "HardStopOnFailure"
