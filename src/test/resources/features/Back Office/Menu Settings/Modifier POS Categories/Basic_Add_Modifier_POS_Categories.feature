Feature: Basic Add Modifier POS Categories
  This script is to validate Add Modifier POC Categories

  @Basic_Add_Modifier_POS_Categories @RegressionSuite @BO_Modifier_POS_Categories @Menu_Settings @Back_Office
  Scenario: Basic_Add_Modifier_POS_Categories_Testcase
    ...
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "nameUS" element at the "EditModifierPOSCategoriesPage" page into the data dictionary with key "nameUS_value2"
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "descriptionUS" element at the "EditModifierPOSCategoriesPage" page into the data dictionary with key "descriptionUS_value2"
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "nameSpanish" element at the "EditModifierPOSCategoriesPage" page into the data dictionary with key "nameSpanish_value2"
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "descriptionSpanish" element at the "EditModifierPOSCategoriesPage" page into the data dictionary with key "descriptionSpanish_value2"
