Feature: Basic Delete Modifier POS Categories
  ...
  @Basic_Delete_Modifier_POS_Categories @RegressionSuite @BO_Modifier_POS_Categories @Menu_Settings @Back_Office
  Scenario: Basic_Delete_Modifier_POS_Categories_Testcase
    ...
    And the user waits for the "delete" element to be "DISABLED" on the "ModifierPOSCategoriesPage" page
