@BasicCancelEditMenuItems
Feature: Basic Cancel Edit Menu Items
  This script is to validate Cancel Edit Menu Items

  @Basic_Cancel_Edit_Menu_Items @RegressionSuite @BO_MenuItems @Menu_Settings @Back_Office
  Scenario: Basic_Cancel_Edit_Menu_Items_Testcase
