Feature: Basic Activate Menu Items
  ...
  @Basic_Activate_Menu_Items @RegressionSuite @BO_MenuItems @Menu_Settings @Back_Office
  Scenario: Basic_Activate_Menu_Items_Testcase
    ...
    And the user clicks the "activateTxt" element at the "ActivateDeActicateMenuItemsPage" page
    #Comment: the user click small Active CheckBox
