Feature: Basic Delete Modifier Display Groups
  This script is to validate Delete Modifier Display Groups

  @Basic_Delete_Modifier_Display_Groups @RegressionSuite @BO_Modifier_Display_Groups @Menu_Settings @Back_Office
  Scenario: Basic_Delete_Modifier_Display_Groups_Testcase
    ...
    And the user waits for the "delete" element to be "DISABLED" on the "ModifiersDispGrpPage" page
