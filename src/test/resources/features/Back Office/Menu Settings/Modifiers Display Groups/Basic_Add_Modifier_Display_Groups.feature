Feature: Basic Add Modifier Display Groups
  This script is to validate Add Modifier Display Groups

  @Basic_Add_Modifier_Display_Groups @RegressionSuite @BO_Modifier_Display_Groups @Menu_Settings @Back_Office
  Scenario: Basic_Add_Modifier_Display_Groups_Testcase
    ...
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "nameUS" element at the "EditModifierDispGrpPage" page into the data dictionary with key "nameUS_value2"
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "descriptionUS" element at the "EditModifierDispGrpPage" page into the data dictionary with key "descriptionUS_value2"
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "nameSpanish" element at the "EditModifierDispGrpPage" page into the data dictionary with key "nameSpanish_value2"
    #Comment: the user store the text on data dictionary
    And store the displayed text of the "descriptionSpanish" element at the "EditModifierDispGrpPage" page into the data dictionary with key "descriptionSpanish_value2"
