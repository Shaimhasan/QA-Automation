Feature: Basic DeActivate Major Menus
  This script is to validate DeActivate Major Menus

  @Basic_DeActivate_Major_Menus @RegressionSuite @BO_Major_Menus @Menu_Settings @Back_Office @Smoke_Testing
  Scenario: Basic_DeActivate_Major_Menus_Testcase
    ...
    And the user waits for the "majorMenusTextVal" element to be "VISIBLE" on the "ActDeactMajorMenusPage" page
    #Comment: user validate the check box is selected
    And the user validates the item in the "availabelChkBoxIsSelected" checkbox is Not checked at the "ActDeactMajorMenusPage" page "validate_CheckBx_Selected" "HardStopOnFailure"
    #Comment: the user click on Edit Button
