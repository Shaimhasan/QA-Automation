...
#    #Comment: the user click on the ID number row
#    And the user clicks the "table" element with dictionary key "#(nameUS_value1)" at the "MajorMenusPage" page with xpath1 "#(IdNumberXpath1)" and xpath2 "#(IdNumberXpath2)"
