Feature: Basic Online Order - Dine In Credit Card - with all lines disabled - Existing User
  This script is to validate Basic Online Order - Dine In Credit Card - with all lines disabled - Existing User

  @issue=1814
  @Basic_Online_Order_Dine_In_Credit_Card_With_All_Lines_Disabled_Existing_User @RegressionSuite @DineIn @OLO @OLO_ALD @OLO_ALD_DineIn @OLO_ALD_DineIn_Existing_User
  Scenario: Basic_Online_Order_Dine_In_Credit_Card_With_All_Lines_Disabled_Existing_User_Testcase
