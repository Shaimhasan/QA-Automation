Feature: Online Order - Dine In Cash - item with Make Line enabled and with all lines disabled - Guest
  This script is to validate Online Order - Dine In Cash - item with Make Line enabled and with all lines disabled - Guest

  @issue=2988
  @OO_Dine_In_Cash_Item_With_MakeLine_Enabled_With_All_Lines_Disabled_Guest_Testcase @RegressionSuite @OLO @OO_ALD @OO_ALD_Guest
