Feature: Online Order - Dine In Cash - item with Make Line and Cut and Wrap enabled and with all lines disabled - Guest
  This script is to validate Online Order - Dine In Cash - item with Make Line and Cut and Wrap enabled and with all lines disabled - Guest

  @issue=3051
  @OO_DineIn_Item_With_MakeLine_And_Cut_And_Wrap_Enabled_With_All_Lines_Disabled_Guest @RegressionSuite @Others @OLO @OLO_ALD @OO_ALD_Guest
  Scenario: OO_DineIn_Item_With_MakeLine_And_Cut_And_Wrap_Enabled_With_All_Lines_Disabled_Guest_Testcase
