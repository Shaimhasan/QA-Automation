Feature: Basic Online Order - Dine In Cash - with Make Line Only - Existing User
  This script is to validate Basic Online Order - Dine In Cash - with Make Line Only - Existing User

  @issue=1819
  @Basic_Online_Order_Dine_In_Cash_With_MakeLine_Only_Existing_User @RegressionSuite @DineIn @OLO @OLO_MakeLine_Only @OLO_MakeLine_Only_DineIn @OLO_MakeLine_Only_DineIn_Existing_User
  Scenario: Basic_Online_Order_Dine_In_Cash_With_MakeLine_Only_Existing_User_Testcase
