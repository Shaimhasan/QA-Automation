Feature: Basic Online Order - Dine In Cash - with Make Line Only - Guest
  ...
  @issue=1758
  @Basic_Online_Order_Dine_In_Cash_With_MakeLine_Only_Guest @RegressionSuite @OLO @OLO_MakeLine_Only @OLO_MakeLine_Only_DineIn @OLO_MakeLine_Only_DineIn_Guest
