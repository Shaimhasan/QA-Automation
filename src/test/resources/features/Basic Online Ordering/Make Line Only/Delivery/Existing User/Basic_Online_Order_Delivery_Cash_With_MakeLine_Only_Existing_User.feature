Feature: Basic Online Order - Delivery Cash - with Make Line Only - Existing User
  This script is to validate Basic Online Order - Delivery Cash - with Make Line Only - Existing User

  @issue=1823
  @Basic_Online_Order_Delivery_Cash_With_MakeLine_Only_Existing_User @RegressionSuite @Delivery @OLO_Delivery @OLO @OLO_MakeLine_Only @OLO_MakeLine_Only_Delivery @OLO_MakeLine_Only_Delivery_Existing_User
  Scenario: Basic_Online_Order_Delivery_Cash_With_MakeLine_Only_Existing_User_Testcase
