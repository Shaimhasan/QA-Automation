Feature: Basic Online Order - Take Out Credit Card - with Make Line Only - Guest
  This script is to validate Basic Online Order - Take Out Credit Card - with Make Line Only - Guest

  @issue=1761
  @Basic_Online_Order_Take_Out_Credit_Card_With_MakeLine_Only_Guest @RegressionSuite @OLO @OLO_MakeLine_Only @OLO_MakeLine_Only_TakeOut @OLO_MakeLine_Only_TakeOut_Guest
