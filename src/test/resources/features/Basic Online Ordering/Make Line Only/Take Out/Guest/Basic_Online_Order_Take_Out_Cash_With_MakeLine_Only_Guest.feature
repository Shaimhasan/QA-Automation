Feature: Basic Online Order - Take Out Cash - with Make Line Only - Guest
  ...
  @issue=1760
  @Basic_Online_Order_Take_Out_Cash_With_MakeLine_Only_Guest @RegressionSuite @OLO @OLO_MakeLine_Only @OLO_MakeLine_Only_TakeOut @OLO_MakeLine_Only_TakeOut_Guest
