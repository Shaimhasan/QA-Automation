Feature: Basic Online Order - Take Out Cash - with Make Line Only - Guest
  This script is to validate Basic Online Order - Take Out Cash - with Make Line Only - Guest

  @issue=1760
  @Basic_Online_Order_Take_Out_Cash_With_MakeLine_Only_Guest @RegressionSuite @TakeOut @OLO @OLO_MakeLine_Only @OLO_MakeLine_Only_TakeOut @OLO_MakeLine_Only_TakeOut_Guest
  Scenario: Basic_Online_Order_Take_Out_Cash_With_MakeLine_Only_Guest_Testcase
