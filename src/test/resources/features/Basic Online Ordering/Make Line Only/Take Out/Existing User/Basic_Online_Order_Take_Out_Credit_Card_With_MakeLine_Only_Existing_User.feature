Feature: Basic Online Order - Take Out Credit Card - with Make Line Only - Existing User
  This script is to validate Basic Online Order - Take Out Credit Card - with Make Line Only - Existing User

  @issue=1822
  @Basic_Online_Order_Take_Out_Credit_Card_With_MakeLine_Only_Existing_User @RegressionSuite @TakeOut @OLO @OLO_MakeLine_Only @OLO_MakeLine_Only_TakeOut @OLO_MakeLine_Only_TakeOut_Existing_User
  Scenario: Basic_Online_Order_Take_Out_Credit_Card_With_MakeLine_Only_Existing_User_Testcase
