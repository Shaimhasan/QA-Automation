Feature: Basic Online Order - Take Out Credit Card - with Prep Station and Cut and Wrap - Guest
  This script is to validate Basic Online Order - Take Out Credit Card - with Prep Station and Cut and Wrap - Guest

  @issue=2810
  @Basic_Online_Order_Take_Out_Credit_Card_With_PC_Guest @RegressionSuite @TakeOut @OLO @OLO_Prep_Station_And_Cut_And_Wrap @OLO_Prep_Station_And_Cut_And_Wrap_TakeOut @OLO_Prep_Station_And_Cut_And_Wrap_TakeOut_Guest @Smoke_Testing
  Scenario: Basic_Online_Order_Take_Out_Credit_Card_With_PC_Guest_Testcase
