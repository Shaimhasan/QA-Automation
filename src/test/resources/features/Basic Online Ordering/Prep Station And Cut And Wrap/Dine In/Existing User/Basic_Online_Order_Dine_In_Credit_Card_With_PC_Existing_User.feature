Feature: Basic Online Order - Dine In Credit Card - with Prep Station and Cut and Wrap - Existing User
  This script is to validate Basic Online Order - Dine In Credit Card - with Prep Station and Cut and Wrap - Existing User

  @issue=2814
  @Basic_Online_Order_Dine_In_Credit_Card_With_PC_Existing_User @RegressionSuite @DineIn @OLO @OLO_Prep_Station_And_Cut_And_Wrap @OLO_Prep_Station_And_Cut_And_Wrap_DineIn @OLO_Prep_Station_And_Cut_And_Wrap_DineIn_Existing_User
  Scenario: Basic_Online_Order_Dine_In_Credit_Card_With_PC_Existing_User_Testcase
