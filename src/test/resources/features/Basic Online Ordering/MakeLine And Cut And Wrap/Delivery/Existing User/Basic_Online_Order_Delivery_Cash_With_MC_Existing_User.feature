Feature: Basic Online Order - Delivery Cash - with Make Line Cut and Wrap - Existing User
  This script is to validate Basic Online Order - Delivery Cash - with Make Line Cut and Wrap - Existing User

  @issue=1829
  @Basic_Online_Order_Delivery_Cash_With_MC_Existing_User @RegressionSuite @OLO @OLO_MakeLine_And_Cut_And_Wrap @OLO_MakeLine_And_Cut_And_Wrap_Delivery @OLO_MakeLine_And_Cut_And_Wrap_Delivery_Existing_User
