Feature: Basic Online Order - Delivery Credit Card - with Make Line and Cut and Wrap - Existing User
  ...
  @issue=1830
  @Basic_Online_Order_Delivery_Credit_Card_With_MC_Existing_User @RegressionSuite @OLO @OLO_MakeLine_And_Cut_And_Wrap @OLO_MakeLine_And_Cut_And_Wrap_Delivery @OLO_MakeLine_And_Cut_And_Wrap_Delivery_Existing_User
