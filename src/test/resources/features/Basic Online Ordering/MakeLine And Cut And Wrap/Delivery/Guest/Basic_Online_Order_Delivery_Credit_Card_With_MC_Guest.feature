Feature: Basic Online Order - Delivery Credit Card - with Make Line and Cut and Wrap - Guest
  This script is to validate Basic Online Order - Delivery Credit Card - with Make Line and Cut and Wrap - Guest

  @issue=1773
  @Basic_Online_Order_Delivery_Credit_Card_With_MC_Guest @RegressionSuite @OLO @OLO_Prep_Station_And_Cut_And_Wrap @OLO_Prep_Station_And_Cut_And_Wrap_Delivery @OLO_Prep_Station_And_Cut_And_Wrap_Delivery_Guest
