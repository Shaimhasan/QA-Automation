Feature: Basic Online Order - Delivery Cash - with Make Line Cut and Wrap - Guest
  This script is to validate Basic Online Order - Delivery Cash - with Make Line Cut and Wrap - Guest

  @issue=1772
  @Basic_Online_Order_Delivery_Cash_With_MC_Guest @RegressionSuite @Delivery @OLO_Delivery @OLO @OLO_MakeLine_And_Cut_And_Wrap @OLO_MakeLine_And_Cut_And_Wrap_Delivery @OLO_MakeLine_And_Cut_And_Wrap_Delivery_Guest
  Scenario: Basic_Online_Order_Delivery_Cash_With_MC_Guest_Testcase
