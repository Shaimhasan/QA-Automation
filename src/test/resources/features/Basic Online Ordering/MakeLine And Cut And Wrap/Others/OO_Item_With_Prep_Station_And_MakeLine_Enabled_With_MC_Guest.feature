Feature: Online Order - Item with Prep Station and Make Line enabled and with Make Line and Cut and Wrap- Guest
  This script is to validate Online Order - Item with Prep Station and Make Line enabled and with Make Line and Cut and Wrap- Guest

  @issue=3039
  @OO_Item_With_Prep_Station_And_MakeLine_Enabled_With_MC_Guest @RegressionSuite @Others @OLO @OLO_MakeLine_And_Cut_And_Wrap @OO_MakeLine_And_cut_And_Wrap_Others @OO_MakeLine_And_Cut_And_Wrap_Others_Guest
  Scenario: OO_Item_With_Prep_Station_And_MakeLine_Enabled_With_MC_Guest_Testcase
