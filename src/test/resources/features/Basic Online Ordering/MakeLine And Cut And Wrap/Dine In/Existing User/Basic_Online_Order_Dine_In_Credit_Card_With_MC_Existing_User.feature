Feature: Basic Online Order - Dine In Credit Card - with Make Line and Cut and Wrap - Existing User
  ...
  @issue=1826
  @Basic_Online_Order_Dine_In_Credit_Card_With_MC_Existing_User @RegressionSuite @OLO @OLO_MakeLine_And_Cut_And_Wrap @OLO_MakeLine_And_Cut_And_Wrap_DineIn @OLO_MakeLine_And_Cut_And_Wrap_DineIn_Existing_User
