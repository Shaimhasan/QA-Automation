Feature: Basic Online Order - Dine In Credit Card - with Make Line and Cut and Wrap - Guest
  ...
  @issue=1769
  @Basic_Online_Order_Dine_In_Credit_Card_With_MakeLine_And_Cut_And_Wrap_Guest @RegressionSuite @OLO @OLO_MakeLine_And_Cut_And_Wrap @OLO_MakeLine_And_Cut_And_Wrap_DineIn @OLO_MakeLine_And_Cut_And_Wrap_DineIn_Guest
  Scenario: Basic_Online_Order_Dine_In_Credit_Card_With_MakeLine_And_Cut_And_Wrap_Guest_Testcase
