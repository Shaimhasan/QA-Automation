Feature: Basic Online Order - Take Out Cash - with Make Line and Cut and Wrap- Guest
  ...
  @issue=1770
  @Basic_Online_Order_Take_Out_Cash_With_MC_Guest @RegressionSuite @OLO @OLO_MakeLine_And_Cut_And_Wrap @OLO_MakeLine_And_Cut_And_Wrap_TakeOut @OLO_MakeLine_And_Cut_And_Wrap_TakeOut_Guest
