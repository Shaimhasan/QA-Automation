Feature: Basic Online Order - Dine In Cash - with Cut and Wrap Only - Existing User
  ...
  @issue=1899
  @Basic_Online_Order_Dine_In_Cash_With_Cut_And_Wrap_Only_Existing_User @RegressionSuite @OLO @OLO_Cut_And_Wrap_Only @OLO_Cut_And_Wrap_Only_DineIn @OLO_Cut_And_Wrap_Only_DineIn_Existing_User
