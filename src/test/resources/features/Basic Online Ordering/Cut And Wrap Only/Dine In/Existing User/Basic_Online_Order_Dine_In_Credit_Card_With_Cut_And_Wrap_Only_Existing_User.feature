Feature: Basic Online Order - Dine In Credit Card - with Cut and Wrap Only - Existing User
  ...
  @issue=1900
  @Basic_Online_Order_Dine_In_Credit_Card_With_Cut_And_Wrap_Only_Existing_User @RegressionSuite @OLO @OLO_Cut_And_Wrap_Only @OLO_Cut_And_Wrap_Only_DineIn @OLO_Cut_And_Wrap_Only_DineIn_Existing_User
