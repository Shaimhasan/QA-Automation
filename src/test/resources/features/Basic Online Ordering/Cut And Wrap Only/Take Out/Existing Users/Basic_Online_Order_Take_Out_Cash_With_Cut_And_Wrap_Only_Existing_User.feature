Feature: Basic Online Order - Take Out Cash - with Cut and Wrap Only - Existing User
  ...
  @issue=1901
  @Basic_Online_Order_Take_Out_Cash_With_Cut_And_Wrap_Only_Existing_User @RegressionSuite @OLO @OLO_Cut_And_Wrap_Only @OLO_Cut_And_Wrap_Only_TakeOut @OLO_Cut_And_Wrap_Only_TakeOut_Existing_User
