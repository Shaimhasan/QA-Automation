Feature: Online Order - Item with Make Line and Cut and Wrap enabled - with Cut and Wrap Only - Guest
  This script is to validate Online Order - Item with Make Line and Cut and Wrap enabled - with Cut and Wrap Only - Guest

  @issue=3018
  @Online_Order_Item_With_MC_Enabled_With_Cut_And_Wrap_Only_Guest @RegressionSuite @Others @OLO @OLO_Cut_And_Wrap_Only @OO_Cut_And_Wrap_Only_Others @OO_Cut_And_Wrap_Only_Others_Guest
  Scenario: Online_Order_Item_With_MC_Enabled_With_Cut_And_Wrap_Only_Guest_Testcase
