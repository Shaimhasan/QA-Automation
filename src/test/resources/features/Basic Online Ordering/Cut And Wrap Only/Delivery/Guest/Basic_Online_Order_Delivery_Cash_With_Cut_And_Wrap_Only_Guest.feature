Feature: Basic Online Order - Delivery Cash - with Cut and Wrap Only - Guest
  This script is to validate Basic Online Order - Delivery Cash - with Cut and Wrap Only - Guest

  @issue=1897
  @Basic_Online_Order_Delivery_Cash_With_Cut_And_Wrap_Only_Guest @RegressionSuite @Delivery @OLO_Delivery @OLO @OLO_Cut_And_Wrap_Only @OLO_Cut_And_Wrap_Only_Delivery @OLO_Cut_And_Wrap_Only_Delivery_Guest
  Scenario: Basic_Online_Order_Delivery_Cash_With_Cut_And_Wrap_Only_Guest_Testcase
