Feature: Online Order - Item with Make Line enabled and with Prep Station and Make Line - Guest
  This script is to validate Online Order - Item with Make Line enabled and with Prep Station and Make Line - Guest

  @issue=3029
  @OO_Item_With_MakeLine_Enabled_With_Prep_Station_And_MakeLine_Guest @RegressionSuite @Others @OLO @OLO_Prep_Station_And_MakeLine @OO_Prep_Station_And_MakeLine_Others @OO_Prep_Station_And_MakeLine_Others_Guest
  Scenario: OO_Item_With_MakeLine_Enabled_With_Prep_Station_And_MakeLine_Guest_Testcase
    ...
    #Comment: User wait to visible the page
    And the user waits for the "chicagoSylPizzaM" element to be "VISIBLE" on the "HomeOLOPage" page
    #Comment: User click on dine in
    And the user clicks the "chicagoSylPizzaM" element at the "HomeOLOPage" page
    #Comment: User wait to visible the page
