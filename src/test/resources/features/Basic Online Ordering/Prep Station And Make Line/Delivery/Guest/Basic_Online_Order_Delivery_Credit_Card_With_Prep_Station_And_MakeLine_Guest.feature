Feature: Basic Online Order - Delivery Credit Card - with Prep Station and Make Line - Guest
  This script is to validate Basic Online Order - Delivery Credit Card - with Prep Station and Make Line - Guest

  @issue=1779
  @Basic_Online_Order_Delivery_Credit_Card_With_Prep_Station_And_MakeLine_Guest @RegressionSuite @OLO @OLO_Prep_Station_And_MakeLine @OLO_Prep_Station_And_MakeLine_Only_Delivery @OLO_Prep_Station_And_MakeLine_Only_Delivery_Guest
  Scenario: Basic_Online_Order_Delivery_Credit_Card_With_Prep_Station_And_MakeLine_Guest_Testcase
