Feature: Basic Online Order - Dine In Cash - with Prep Station and Make Line - Existing User
  This script is to validate Basic Online Order - Dine In Cash - with Prep Station and Make Line - Existing User

  @issue=1831
  @Basic_Online_Order_Dine_In_Cash_With_Prep_Station_And_MakeLine_Existing_User @RegressionSuite @OLO @OLO_Prep_Station_And_MakeLine @OLO_Prep_Station_And_MakeLine_DineIn @OLO_Prep_Station_And_MakeLine_DineIn_Existing_User
