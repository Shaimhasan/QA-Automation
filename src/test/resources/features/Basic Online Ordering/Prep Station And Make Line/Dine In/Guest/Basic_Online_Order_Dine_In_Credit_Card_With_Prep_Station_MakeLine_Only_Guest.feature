Feature: Basic Online Order - Dine In Credit Card - with Prep Station and Make Line - Guest
  ...
  @issue=1775
  @Basic_Online_Order_Dine_In_Credit_Card_With_Prep_Station_MakeLine_Only_Guest @RegressionSuite @DineIn @OLO @OLO_Prep_Station_And_MakeLine @OLO_Prep_Station_And_MakeLine_Only_DineIn @OLO_Prep_Station_And_MakeLine_Only_DineIn_Guest @Smoke_Testing
