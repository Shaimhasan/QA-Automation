Feature: Basic Online Order - Dine In Credit Card - with all lines enabled - Existing User
  This script is to validate Basic Online Order - Dine In Credit Card - with all lines enabled - Existing User

  @issue=1838
  @Basic_Online_Order_Dine_In_Credit_Card_With_All_Lines_Enabled_Existing_User @RegressionSuite @DineIn @OLO @OLO_ALE @OLO_ALE_DineIn @OLO_ALE_DineIn_Existing_User
  Scenario: Basic_Online_Order_Dine_In_Credit_Card_With_All_Lines_Enabled_Existing_User_Testcase
