Feature: Basic Clear Delivery Pending Order
  This script is to validate Basic Clear Delivery Pending Order Testcase

  @Basic_Clear_Delivery_Pending_Order @ClearAllPendingOrders @ClearDeliveryPendingOrders
  Scenario: Basic_Clear_Delivery_Pending_Order_Testcase
