...
public class EditModifierDispGrpPage extends BasePO {
    ...
    private By cancelBtn = By.xpath("//button[@onclick='BO_MN_MDG_ADDEDT_Save();']//preceding-sibling::button[text()='Cancel']");
