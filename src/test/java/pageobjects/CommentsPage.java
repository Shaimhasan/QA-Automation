...
public class CommentsPage extends BasePO {

    private By addBtn = By.id("btn_BO_MN_COM_AddNew");
    private By editBtn = By.id("btn_BO_MN_COM_Edit");
    private By search = By.xpath("//input[@id='txtSearch']");
    private By table = By.id("tbl_BO_List_MN_COM");
    private By history = By.id("btn_BO_HISTORY");
    private By delete = By.id("btn_BO_MN_COM_Del");
