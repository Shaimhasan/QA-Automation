...
public class MixtureRecipePage extends BasePO {

    private By addBtn = By.id("btn_BO_IN_MIX_AddNew");
    private By editBtn = By.id("btn_BO_IN_MIX_Edit");
    private By table = By.id("tbl_BO_List_IN_MIX");
