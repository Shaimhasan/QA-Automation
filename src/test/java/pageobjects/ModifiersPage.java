...
public class ModifiersPage extends BasePO {

    private By addBtn = By.id("btn_BO_MN_MOD_AddNew");
    private By editBtn = By.id("btn_BO_MN_MOD_Edit");
    private By search = By.xpath("//input[@id='txtSearch']");
    private By table = By.id("tbl_BO_List_MN_MOD");
    private By history = By.id("btn_BO_HISTORY");
    private By actAndDeact = By.id("btn_BO_MN_MOD_AVAL");
