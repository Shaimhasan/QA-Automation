...
public class ReceivingItemsPage extends BasePO {

    private By addBtn = By.id("btn_BO_IN_VIT_AddNew");
    private By editBtn = By.id("btn_BO_IN_VIT_Edit");
    private By table = By.id("tbl_BO_List_IN_VIT");
    private By history = By.id("btn_BO_HISTORY");
    private By delete = By.id("btn_BO_IN_VIT_Del");
