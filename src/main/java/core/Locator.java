...
public class Locator {
    ...
    public static By getLocator(Loc type, String locator, Object... params) {
        ...
        switch (type) {
            case CSS:
                by = By.cssSelector(String.format(locator, params));
                break;
            case XPATH:
                by = By.xpath(String.format(locator, params));
                break;
            case ID:
                by = By.id(String.format(locator, params));
                break;
            case NAME:
                by = By.name(String.format(locator, params));
                break;
            case CLASSNAME:
                by = By.className(String.format(locator, params));
                break;
            case TAGNAME:
                by = By.tagName(String.format(locator, params));
                break;
            case LINKTEXT:
                by = By.linkText(String.format(locator, params));
                break;
            case PARTIALLINKTEXT:
                by = By.partialLinkText(String.format(locator, params));
                break;
